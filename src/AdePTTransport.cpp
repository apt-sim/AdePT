...
std::unordered_map<size_t, size_t> AdePTTransport::fglobal_volume_to_hit_map;
std::unordered_map<size_t, const G4VPhysicalVolume *> AdePTTransport::fglobal_vecgeom_to_g4_map;
int AdePTTransport::fGlobalNumSensitive = 0;
...
void AdePTTransport::CreateVecGeomWorld()
{
...
adeptint::VolAuxData *AdePTTransport::CreateVolAuxData(const G4VPhysicalVolume *g4world,
...
void AdePTTransport::ProcessGPUHits(HostScoring::Stats &aStats)
{
...
void AdePTTransport::FillG4NavigationHistory(unsigned int aNavIndex, G4NavigationHistory *aG4NavigationHistory)
{
...
void AdePTTransport::FillG4Step(GPUHit *aGPUHit, 
                                  G4Step *aG4Step, 
