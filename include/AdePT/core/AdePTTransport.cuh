  ...
  do {
    ...
    if (numElectrons > 0) {
      ...
      TransportElectrons<AdeptScoring, SteppingAction><<<transportBlocks, TransportThreads, 0, electrons.stream>>>(
          ...
          VolAuxArray::GetInstance().fAuxData_dev, steppingActionParams);
    ...
    if (numGammas > 0) {
      ...
      TransportGammas<AdeptScoring, SteppingAction><<<transportBlocks, TransportThreads, 0, gammas.stream>>>(
          gammas.trackmgr, secondaries, gammas.leakedTracks, scoring_dev, VolAuxArray::GetInstance().fAuxData_dev, steppingActionParams);
