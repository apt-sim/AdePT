...
public:
  ...
  void setPrimaryForG4ID(int g4id, G4PrimaryParticle *primary) { 
    if (g4PrimaryMap[g4id] == nullptr) g4PrimaryMap[g4id] = primary;
  }
  ...
  {
    if (g4UserTrackInfoMap[g4id] == nullptr) g4UserTrackInfoMap[g4id] = userTrackInfo;
  }
  ...
  void setCreatorProcessForG4ID(int g4id, G4VProcess *creatorProcess) { 
    if (g4CreatorProcessMap[g4id] == nullptr) g4CreatorProcessMap[g4id] = creatorProcess; }
