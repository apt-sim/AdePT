...
__device__ void createOneTrack(unsigned int index, uint64_t rngBase, track &aTrack, unsigned int eventId)
{
...
__global__ void createTracks(adept::BlockData<track> *trackBlock, const vecgeom::VPlacedVolume *world,
